...
import { useUpdateFair } from "../Services/FairsService";
import GenericModal from "./GenericModal";
import CenterAlert from "./CenterAlert";

type EditFairModalProps = {
  fair: {
    id: number;
    name: string;
    description: string;
...
const EditFairModal = ({ fair, onClose }: EditFairModalProps) => {
  const { mutate: updateFair } = useUpdateFair();
  ...
  return (
    <GenericModal show={!!fair} onClose={onClose} title="Edit Fair">
      {errorMessage && (
        <CenterAlert
